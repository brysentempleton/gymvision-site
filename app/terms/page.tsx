...
const SECTIONS = [
  {
    ...
    body: [
      "These terms cover this website (gymvision.app), the early-access waitlist, and the AI receptionist demo call. The GymVision platform itself is in private beta; pilot gyms get a separate agreement that covers the actual service.",
    ],
  },
  {
    title: "The demo call",
